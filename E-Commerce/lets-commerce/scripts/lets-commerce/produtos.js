...
const porcentagemDescontoBoleto = 10;
const numeroParcelasPadrao = 10;

const atualizaListaProdutos = (listaProdutos) => {
    let cards = '';
    const produtosSemMap = listaProdutos ? listaProdutos : produtos;
    const produtosMapeados = produtosSemMap.map((produto) => ({
        ...produto,
        precoComDescontoBoleto: aplicaDesconto(produto.preco, porcentagemDescontoBoleto),
    ...
    for (produto of produtosMapeados){
        ...
        <div class="card">
            ...
            <div class="descricao-card">
                ...
                <p><b>10x sem juros de R$${produto.precoParcelado}0</b></p>
                <p><b>ou R$${produto.precoComDescontoBoleto} no boleto</b></p>
            </div>
            <div class="acoes adicionar-ao-carrinho" onclick="adicionarProdutoCarrinho(${produto.id})">
